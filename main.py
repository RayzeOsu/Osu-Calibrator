...
# ============================================================================
# PYINSTALLER RESOURCE + PERSISTENT SONG HELPERS
# ============================================================================
...
class RecommendationEngine:
    ...
    def build_summary(
        ...
        # ------------------------------------------------------------------
        # Feature 2 (v1.0.1): The "Why Did It Change?" Log
        # Compare current stats to previous stats and generate plain English.
        # ------------------------------------------------------------------
        ...
        if sep_on and not rt_override_applied:
            ...
            if eff_r > eff_p:
                ...
                # FIX 3: Promote anti-sticky override status to "warn"
                status = "warn"
        ...
        # Aggregate key counts for the tip picker
